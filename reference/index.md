...
- [`dexp_gpl_df()`](https://reichlab.io/alloscore2/reference/dexp_gpl_df.md)
  :

  Create a list of derivatives of expected gpl losses from a `gpl_df`

- [`dexp_gpl_loss()`](https://reichlab.io/alloscore2/reference/dexp_gpl_loss.md)
  : Derivative of the expected gpl loss

- [`dexp_over_loss()`](https://reichlab.io/alloscore2/reference/dexp_over_loss.md)
  : Derivative of the expected over-prediction loss

- [`dexp_under_loss()`](https://reichlab.io/alloscore2/reference/dexp_under_loss.md)
...
- [`exp_over_loss()`](https://reichlab.io/alloscore2/reference/exp_over_loss.md)
  : Expected g-linear loss for over-prediction of a random outcome

- [`exp_under_loss()`](https://reichlab.io/alloscore2/reference/exp_under_loss.md)
  : Expected g-linear loss for under-prediction of a random outcome

- [`gpl()`](https://reichlab.io/alloscore2/reference/gpl.md) : Get the
  gpl loss data frame of an allocation
...
- [`oracle_allocate_direct()`](https://reichlab.io/alloscore2/reference/oracle_allocate_direct.md)
...
- [`over_loss()`](https://reichlab.io/alloscore2/reference/over_loss.md)
  : Basic g-linear loss for over-prediction of an outcome

- [`pdqr_factory()`](https://reichlab.io/alloscore2/reference/pdqr_factory.md)
  : Build a p/d/q/r function with parameters fixed

- [`plot_components()`](https://reichlab.io/alloscore2/reference/plot_components.md)
...
- [`plot_scores_slim()`](https://reichlab.io/alloscore2/reference/plot_scores_slim.md)
...
- [`slim()`](https://reichlab.io/alloscore2/reference/slim.md) : Drop
  the heavy list columns of an allocated data frame
...
- [`under_loss()`](https://reichlab.io/alloscore2/reference/under_loss.md)
  : Basic g-linear loss for under-prediction of an outcome

- [`weights(`*`<allocated>`*`)`](https://reichlab.io/alloscore2/reference/weights.allocated.md)
  : Get the weights of an allocated data frame

- [`zxh_tab2`](https://reichlab.io/alloscore2/reference/zxh_tab2.md) :
  Multiproduct newsboy data with Normal demand

- [`zxh_tab3`](https://reichlab.io/alloscore2/reference/zxh_tab3.md) :
