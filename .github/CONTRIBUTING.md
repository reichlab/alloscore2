# Contributing to alloscore2

This outlines how to propose a change to `alloscore2`.
...
- Fork the package and clone onto your computer. If you haven't done this before, we recommend using `usethis::create_from_github("reichlab/alloscore2", fork = TRUE)`.
...
Please note that the alloscore2 project is released with a
