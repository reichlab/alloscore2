...
This outlines how to propose a change to `alloscore2`. For more general
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("reichlab/alloscore2", fork = TRUE)`.
...
Code of Conduct](https://reichlab.io/alloscore2/dev/CODE_OF_CONDUCT.md).
